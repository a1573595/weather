...
abstract class WeatherClient {
  ...
  @GET("/2.5/weather?lat={lat}&lon={lon}&units=metric&appid=6adf87802066a3ee22591eb3f8abfe0c")
  Future<CurrentWeather> currentWeather(
      @CancelRequest() CancelToken cancelToken, @Path('lat') double lat, @Path('lon') double lng);

  @GET("/2.5/onecall?lat={lat}&lon={lon}&units=metric&appid=6adf87802066a3ee22591eb3f8abfe0c")
